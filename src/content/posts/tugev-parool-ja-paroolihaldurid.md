...
## Sellepärast on olemas paroolihaldurid

Paroolihaldur on rakendus, mis genereerib ja salvestab sinu eest juhuslikke, unikaalseid paroole iga konto jaoks — sina pead meeles pidama ainult ühe pealoosungi (master password), mis avab kogu haldurit. Kõik muu käib automaatselt: haldur täidab parooli sisse, kui logid teenusesse sisse, ja hoiatab, kui mõni parool on nõrk või on juba lekitatud.

See lahendab kaks levinud probleemi korraga:

1. **Sama parooli taaskasutamine.** Kui kasutad üht parooli mitmes kohas ja üks nendest teenustest lekib, saavad ründajad sama kombinatsiooniga proovida kõiki teisi sinu kontosid. Unikaalne parool iga koha jaoks tähendab, et üks lekk ei mõjuta teisi kontosid.
...
- Loo pealoosung, mis on pikk, kuid sinu jaoks meeldejääv — näiteks neli juhuslikku sõna koos.
- Luba kahefaktoriline autentimine kõikjal, kus see on saadaval — parool üksi ei kaitse sind enam, kui keegi selle juba teab.
- Lase haldur otsida taaskasutatud ja lekkinud paroole ning vaheta need järk-järgult ära.

See on üks väheseid turvalisuse harjumusi, mis nõuab ühekordset seadistamist ja annab pideva kaitse — ilma, et peaksid iga päev midagi rohkem tegema.
