...
"Krüpto" on üks neist sõnadest, mis on hakanud tähendama liiga palju eri asju korraga. Kui keegi ütleb "ma tegelen krüptoga", võib ta mõelda kolme täiesti erinevat asja — ja vahet on kasulik teada, eriti kui loed midagi turvalisuse või investeerimise kohta.
...
Kui sulle öeldakse, et "krüptograafia on riskantne investeering", on tegu segadusega — krüptograafia on turvatehnoloogia, mitte investeering. Kui sulle öeldakse, et "plokiahel on Bitcoini konkurent", on ka see ebatäpne — Bitcoin *kasutab* üht plokiahelat, aga plokiahelaid ja nende rakendusi on palju.

Lühikokkuvõte:

| Termin | Mis see on | Näide |
|---|---|---|
| Krüptograafia | Meetod info kaitsmiseks | HTTPS, sõnumite krüpteering |
| Plokiahel | Hajutatud andmebaasi tehnoloogia | Tarneahela jälgimine, nutilepingud |
| Krüptoraha | Plokiahela peal töötav digitaalne vara | Bitcoin, Ethereum |

Kolme mõistet lahus hoides on palju lihtsam aru saada, millest uudistes või investeerimissoovitustes tegelikult juttu on.
